...
export const formValidationSchema = yup.object({
  ...
  password: yup
    ...
    .test('password-strength', 'Password must contain at least 1 number', (value) => hasNumber.test(value || ''))
    .test('password-strength', 'Password must contain at least 1 uppercase letter', (value) => hasUpperCase.test(value || ''))
    .test('password-strength', 'Password must contain at least 1 lowercase letter', (value) => hasLowerCase.test(value || ''))
    .test('password-strength', 'Password must contain at least 1 special character', (value) => hasSpecialChar.test(value || '')),
  ...
  image: yup
    ...
    .test('is-valid-type', 'File must be a PNG or JPEG image', function (value) {
